...
I analyzed and compared two distributions and their summary statistics to find out which age group of Canadian voters is less likely to hold a favourable opinion of the Federal Green Party. My analysis says that Canadians over the age of 50 are less likely to give the party a high rating. This tells the party that it should consider giving special incentives to Canadians over 50 to secure their votes.
...
# Discussion of Histogram 1 and Related Findings:

Histogram 1 shows us the distribution of the ages of the respondents who gave a low rating to the Federal Green Party (a low rating is a rating below 55 and is not indicative of a favourable opinion). A histogram is a graph that shows us the distribution of a variable and the frequency of various subgroups of values in the data. The y-axis in histogram 2 tells us, for every age group, how many respondents gave the party a low rating.
...
theme_bw()
```
# Discussion of Histogram 2 and Related Findings:

Histogram 2 shows us the distribution of the ages of the respondents who gave a high rating to the Federal Green Party (a high rating is a rating above 55 and is indicative of a favourable opinion of the party). The y-axis in the histogram above tells us, for every age group, how many respondents gave a high rating to the party.
...
-Citation for the package 'blogdown':
...
-Citation for the literature and other websited used (other websites used include Github and Netlify. Both helped me make my blogpost and upload it:
...
Github. Accessed September 27, 2020. https://github.com.

netlify. Accessed September 27, 2020. https://www.netlify.com.
